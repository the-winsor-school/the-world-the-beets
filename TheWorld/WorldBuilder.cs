	...
	public static class WorldBuilder
	{
		...
		public static Area BuildWorld()
		{
			...
			start.AddCreature(new Creature()
            {
				...
				Stats = new StatChart() { Level = 1, MaxHPs = 10, HPs = 10, Atk = new Dice(1, Dice.Type.D4), Def = new Dice(1, Dice.Type.D4), Exp = 3 }
			}, "bunny");
			...
			stream.AddCreature(new Creature()
            {
				...
				Stats = new StatChart() { MaxHPs = 10, HPs = 10, Atk = new Dice(1, Dice.Type.D6), Def = new Dice(1, Dice.Type.D4), Level = 1, Exp = 5 }
			}, "frog");
